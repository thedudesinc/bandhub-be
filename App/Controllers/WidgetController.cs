...
[ApiController]
[Route("api/widget")]
public class WidgetInstanceController
{
    private readonly IWidgetService _service;

    public WidgetInstanceController(IWidgetService service)
    {
        _service = service;
    }
    ...
    [HttpGet]
    [Route("{id}")]
    public async Task<ActionResult<WidgetOutput>> Get(Guid id, CancellationToken ct)
    {
    ...
    public async Task<ActionResult<WidgetOutput>> Create([FromBody] WidgetInput user, CancellationToken ct)
    {
    ...
    [HttpPut]
    [Route("{id}")]
    public async Task<ActionResult<WidgetOutput>> Update(Guid id, [FromBody] WidgetInput user, CancellationToken ct)
    {
